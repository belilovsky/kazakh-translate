...
## ҚОСЫМША ТЕКСЕРУ НҮКТЕЛЕРІ (issues тізіміне жаз):
6. **Тәуелдік үйлесімі**: Иесі бар зат есімде тәуелдік жалғауы бар ма? «Оның баласын» (3SG POSS) — тәуелдік + арнайы септік форма сақталған ба? (баласын, баласына, баласында — дұрыс; баласыны, баласыға — қате)
7. **Сан есімнен кейін жекеше**: Сан есімнен кейін зат есім жекеше тұрда ма? (бес бала — дұрыс, бес балалар — қате)
8. **Конверб формалары**: Бағыныңқы сөйлемдер конверб арқылы берілген бе? («когда» → -ғанда/-генде, «если» → -са/-се, «чтобы» → + үшін, «пока» → -ғанша/-генше) Тікелей «который» аудармасы бар ма? (-ған/-ген/-атын/-етін/-ар/-ер + зат есім болуы керек)
9. **Залық жұрнақтар тәртібі**: Болымсыздық (-ма/-ме/-ба/-бе) залықтан кейін, шақтан бұрын тұр ма? (негіз + залық + болымсыздық + шақ + жіктік — дұрыс тәртіп)

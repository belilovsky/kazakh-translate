...
6. 3 жақ тәуелдік + септік: баласын (VIN), баласына (DAT), баласында (LOC) — арнайы форма қолданылған ба? (баласыны, баласыға, баласыда — қате)
7. Сан есім + зат есім: зат есім жекеше тұрда ма? (бес бала — дұрыс, бес балалар — қате)
8. Бағыныңқы сөйлемдер: конверб форма қолданылған ба? («когда» → -ғанда/-генде, «если» → -са/-се, «чтобы» → + үшін, «пока» → -ғанша/-генше, «после того как» → -ып/-іп)
9. «Который» сөзі тікелей аударылмаған ба? (қатысымша конструкция керек: -ған/-ген, -атын/-етін, -ар/-ер + зат есім)
10. Болымсыздық тәртібі: негіз + (салт) + болымсыздық + шақ + жіктік. Болымсыздық шақтан кейін тұрмауы керек.
